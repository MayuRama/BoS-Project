        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            >
              {loading ? (
                <>
                  <div className="w-4 h-4 border-2 border-bos-blue/30 border-t-bos-blue rounded-full animate-spin" />
                  Signing in...
                </>
          ...
          <div className="mt-5 p-3 bg-white/5 border border-white/10 rounded-lg text-xs text-white/40">
            ...
            <p>Enter any values in all three fields to log in.</p>
            <p>You'll be logged in as: <span className="text-white/70">Premier Exchange Co. — Tier 1</span></p>
          </div>
        </div>
